...
const apifURL =
  "//api.openweathermap.org/data/2.5/forecast?id=5585000&appid=ed322eeeaba3fbf6a615b4175fa51fdf&units=imperial";
fetch(apifURL)
  ...
  const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585000&appid=cd74f180fdef1030c4c735b5fcd2b152&units=imperial";
  fetch(apiURL)
   .then((response) => response.json())
   .then((weatherinfo) => {
